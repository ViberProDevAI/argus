...
final class GeminiEmbeddingService {
    ...
    // 2026-04-22: embedding-001 sunset edildi (404 NOT_FOUND).
    // Yeni stabil model text-embedding-004 (768-dim, çok dilli, Türkçe OK).
    // RAG pending 200'e ulaşmıştı — bu fix'le sync kuyruğu akmaya başlar.
    private let model = "models/text-embedding-004"
