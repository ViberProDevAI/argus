...
actor AlkindusAnomalyDetector {
    ...
    struct ModuleRollingStats: Codable {
        ...
        var allTimeStd: Double {
            ...
            // Minimum std tabanı: Bütün skorlar aynıysa (ör. ilk kalibrasyonda hepsi 50)
            // std = 0 olurdu; bu durumda z-score ve anomaly detection sessiz fail ederdi.
            // Taban 5 uygulayarak en az küçük bir "beklenen dalgalanma" varsayıyoruz.
            return max(std, 5.0)
        }
