                    ...
                    VStack(spacing: 24) {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            HStack {
                                Text("Atlas (Kalite):")
                                Spacer()
                                Text(String(format: "%.0f", result.qualityScore)).foregroundColor(InstitutionalTheme.Colors.holo)
                            }
                            
                            HStack {
                                Text("Aether (Makro):")
                                Spacer()
                                Text(String(format: "%.0f", result.macroScore)).foregroundColor(InstitutionalTheme.Colors.holo)
                            }
                        }
                        .padding()
                        .background(InstitutionalTheme.Colors.surface1)
